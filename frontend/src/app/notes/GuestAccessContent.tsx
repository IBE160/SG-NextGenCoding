...
export default function GuestAccessContent({
  initialNotes,
  isUserAuthenticated,
}: GuestAccessContentProps) {
  ...
  if (checkUsageLimit()) {
    return (
      <>
        ...
        <p>
          You have used your {GUEST_LIMIT} free accesses. Please log in or
          register.
        </p>
  ...
  return (
    <>
      ...
      <p>
        You have {currentUsage} out of {GUEST_LIMIT} free uses. Please log in or
        register for full access.
      </p>
      <button onClick={handleFeatureUse}>Use Core Feature (Simulated)</button>{' '}
      {/* Simulated usage */}
