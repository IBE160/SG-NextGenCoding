    ...
    const checkUserStatus = () => {
      ...
      if (hasAccessToken) {
        ...
        const count = parseInt(
          localStorage.getItem(GUEST_UPLOAD_KEY) || '0',
          10,
        )
    ...
    <div className="container mx-auto p-4">
      ...
      {!sessionLoaded ? (
        ...
        >
          ...
          <p>
            You have used {MAX_GUEST_UPLOADS} free uploads. Please{' '}
        ...
        <>
          {isGuest && (
            <p className="mb-4 text-center text-gray-600">
              As a guest, you have {MAX_GUEST_UPLOADS - guestUploadsCount} free
              uploads remaining.
            </p>
          )}
          {!isGuest && (
          ...
          <div className="mt-4 text-center">
            <button
              ...
              className="rounded-md bg-gray-300 px-6 py-3 text-lg font-semibold text-gray-800 transition-colors hover:bg-gray-400"
            >
              Cancel
            </button>
            {isGuest && (
              <button
                ...
                className="ml-4 rounded-md bg-red-500 px-6 py-3 text-lg font-semibold text-white transition-colors hover:bg-red-600"
              >
                Reset Guest Uploads
              </button>
            )}
